...
public readonly record struct StaticFieldReadArgs(ProcessThreadId ProcessThreadId, ModuleId ModuleId, MdMethodDef MethodToken, uint MethodOffset, MdToken FieldToken);
public readonly record struct StaticFieldWriteArgs(ProcessThreadId ProcessThreadId, ModuleId ModuleId, MdMethodDef MethodToken, uint MethodOffset, MdToken FieldToken);
public readonly record struct InstanceFieldReadArgs(ProcessThreadId ProcessThreadId, ModuleId ModuleId, MdMethodDef MethodToken, uint MethodOffset, MdToken FieldToken, ProcessTrackedObjectId ObjectId);
public readonly record struct InstanceFieldWriteArgs(ProcessThreadId ProcessThreadId, ModuleId ModuleId, MdMethodDef MethodToken, uint MethodOffset, MdToken FieldToken, ProcessTrackedObjectId ObjectId);