...
public class PublicationClassificationTests
{
    ...
    [Fact]
    public void RepeatedUnconditionalStore_DoesCreateHappensBeforeEdge_IsNotReported()
    {
        // Arrange
        var mutate = _metadata.AddMethod(_metadata.AddType("Mutator"), "Mutate");
        var read = _metadata.AddMethod(_metadata.AddType("Consumer"), "Consume");
    ...
    [Fact]
    public void RepeatedStoreLoad_DoesNotCreateObserverToObserverEdge_UnrelatedRaceIsStillReported()
    {
        // Arrange
        var mutate = _metadata.AddMethod(_metadata.AddType("Mutator"), "Mutate");
        var read = _metadata.AddMethod(_metadata.AddType("Consumer"), "Consume");
