...
{
    public record InformationReport(string Reporter, string Category, string MessageFormat, object?[]? Arguments, int Pid, IShadowThread Thread, SourceLink? SourceLink)
