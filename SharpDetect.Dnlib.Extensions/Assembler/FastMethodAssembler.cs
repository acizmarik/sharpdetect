...
namespace SharpDetect.Dnlib.Extensions.Assembler
{
    ...
    public class FastMethodAssembler
    {
        ...
        public FastMethodAssembler(MethodDef method, IReadOnlyDictionary<Instruction, MDToken> stubs)
        {
            this.method = method;
            this.stubs = stubs;
            this.bytecode = null!;
        ...
        private MDToken GetToken(Instruction instruction)
        {
            ...
            {
                // TODO: cache these
                //((ModuleDefMD)method.Module).Metadata.StringsStream.CreateReader().TryReadZeroTerminatedUtf8String
