...
namespace SharpDetect.UnitTests.Runtime.Threads
{
    public class ShadowThreadTests : TestsBase
    {
        ...
        public static void ShadowThread_Initialize()
        {
            ...
            using var shadowThread = new ShadowThread(processId, threadId, virtualThreadId, new SchedulerBase.SchedulerEpochChangeSignaller());
        ...
        public static void ShadowThread_ExecuteWaitingJobsOnEpochChanged()
        {
            ...
            // Act
            using (var shadowThread = new ShadowThread(processId, threadId, virtualThreadId, signaller))
            {
                shadowThread.Start();
